const figmaExpression =
  /^https:\/\/([\w.-]+\.)?figma.com\/([\w-]+)\/([0-9a-zA-Z]{22,128})(?:\/.*)?$/gi;
const loomExpression =
  /^https:\/\/([\w.-]+\.)?loom.com\/share\/([0-9a-zA-Z]{22,128})(?:\/.*)?(\?.*)?/gi;
const codepenExpression =
  /^https:\/\/([\w.-]+\.)?codepen.io\/([0-9a-zA-Z]{1,32})\/pen\/([0-9a-zA-Z]{1,32})(?:\/.*)?$/gi;
const codesandboxExpression =
  /^https:\/\/([\w.-]+\.)?codesandbox.io\/(embed|s)\/[-a-zA-Z0-9()@:%_+.~#?&//=]*$/gi;
const riveExpression =
  /^https:\/\/([\w.-]+\.)?rive.app\/s\/[-a-zA-Z0-9()@:%_+.~#?&//=]*$/gi;
const playExpression =
  /^https:\/\/([\w.-]+\.)?(share\.)createwithplay.com\/project\/[-a-zA-Z0-9()@:%_+.~#?&//=]*$/gi;
const tomeExpression =
  /^https:\/\/([\w.-]+\.)?tome.app\/[0-9a-zA-Z]*\/[-a-zA-Z0-9()@:%_+.~#?&//=]*$/gi;
const youtubeExpression =
  /^https:\/\/([\w.-]+\.)?youtube.com\/watch\?v=([-a-zA-Z0-9()@:%_+.~#?&//=]*)$/gi;
