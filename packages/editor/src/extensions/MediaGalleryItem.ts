...
export type MediaGalleryItemOptions = {};

export type MediaGalleryItemAttributes = Omit<
  InlineAttachmentAttributes,
  "optimistic_id"
> & {
  /**
  ...
  addAttributes() {
    return {
      ...
      optimistic_id: {
        ...
        parseHTML: (element) =>
          element.getAttribute("optimistic_id") || element.getAttribute("id"),
      },
      file_type: {
        default: "",
      },
