import { type ChainedCommands, type Editor, Node } from "@tiptap/core";
      ...
      insertAttachments:
        ...
        ({ tr, state, dispatch }) => {
          ...
          const nodes = attachments.map((attachment) =>
            schema.nodes.postNoteAttachment.create(attachment),
          );
