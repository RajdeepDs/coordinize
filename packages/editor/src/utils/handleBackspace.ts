// Fork of the official ListKeyMap helper function to fix backspace adjacent to list items with a spanned selection
// https://github.com/ueberdosis/tiptap/blob/main/packages/extension-list-keymap/src/list-keymap.ts

import { type Editor, isAtStartOfNode, isNodeActive } from "@tiptap/core";
...
export const handleBackspace = (
  ...
  if (
    ...
    // NOTE: this is the only change from the original function
  ...
  const previousListItemHasSubList = listHelpers.listItemHasSubList(
    name,
    editor.state,
    prevNode,
  );
  ...
  if (
    listHelpers.hasListItemBefore(name, editor.state) &&
